...
let ru = {
    translation: {
        ...
        heroHomeSubtitle: 'Мы работаем для вашей экономии! Также, в результате работы, уменьшается экологический отпечаток и снижается расход энергии. Наша команда настроена на долгосрочное развитие и популяризацию использования альтернативных источников энергии.',
